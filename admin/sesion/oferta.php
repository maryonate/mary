...
switch ($accion) {
        case 'agregar':
            ...
            $result = $conn->query("INSERT INTO `oferta` (`codigo`, `nombreo`, `codigoprod`, `descu`) VALUES (NULL, '$nombreo', '$codigoprod', '$descu');");
        ...
        case 'seleccionar':
            $result=$conn->query("SELECT codigo,nombre,foto,precio FROM oferta WHERE codigo=$codigo");
            $oferta = mysqli_fetch_all($result, MYSQLI_ASSOC);
